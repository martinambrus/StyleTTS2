...
- **[ASR](https://github.com/yl4579/StyleTTS2/tree/main/Utils/ASR) folder**: It contains the pre-trained text aligner, which was pre-trained on English (LibriTTS), Japanese (JVS), and Chinese (AiShell) corpus. It works well for most other languages without fine-tuning, but you can always train your own text aligner with the enhanced implementation here: [martinambrus/AuxiliaryASR (phonemizer branch)](https://github.com/martinambrus/AuxiliaryASR/tree/phonemizer) or the original [yl4579/AuxiliaryASR](https://github.com/yl4579/AuxiliaryASR).
- **[JDC](https://github.com/yl4579/StyleTTS2/tree/main/Utils/JDC) folder**: It contains the pre-trained pitch extractor, which was pre-trained on English (LibriTTS) corpus only. However, it works well for other languages too because F0 is independent of language. If you want to train on singing corpus, it is recommended to train a new pitch extractor with the updated code here: [martinambrus/PitchExtractor](https://github.com/martinambrus/PitchExtractor) or the original [yl4579/PitchExtractor](https://github.com/yl4579/PitchExtractor).
